...
if($result->rowCount()>0){
				...
				<div class="col fill_height">
					...
					<div class="search_tabs_container">
						<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							...
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="assets/images/bus.png" alt="">Araba Kİralama</div>
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="assets/images/departure.png" alt="">Uçuşlar</div>
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="assets/images/island.png" alt="">Gezİler</div>
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="assets/images/cruise.png" alt="">Turlar</div>
	...
	<div class="intro">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="intro_title text-center">GEZİLERİMİZ İÇİN FIRSATLAR</h2>
				</div>
			</div>
			<div class="row">
    ...
    ?>
							...
							<div class="button intro_button"><div class="button_bcg"></div><a href="<?php echo APPURL;?>/detail/trips.php?id=<?php echo $row['id'] ?>">Daha Fazla<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1><?php echo $row['destination']; ?> </h1>
								<div class="intro_price">Fiyat $<?php echo $row['price']; ?> </div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section_title">GEMİ YOLCULUĞUMUZ İÇİN EN İYİ FIRSATLAR</h2>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price">$<?php echo $row['price']; ?><span>Gecelik</span></div>
...
?> </p>
									...
									<div class="offers_link"><a href="<?php echo APPURL;?>/detail/cruise.php?id=<?php echo $row['id'] ?>">Daha Fazla</a></div>
								</div>
							</div>
						</div>
					</div>
