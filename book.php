...
<div class="home">
		...
		<div class="home_content">
			<div class="home_title">REZERVASYON</div>
		</div>
	</div>
...
?>
                                        ...
                                        <form method="POST">
                                            ...
                                            <div class="row mb-4">
                                              ...
                                              <div class="col">
                                                <div class="form-outline">
                                                  ...
                                                  <label class="form-label" for="form6Example2">Soyisim</label>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-outline mb-4">
                                              ...
                                              <label class="form-label" for="form6Example3">Telefon Numarası:</label>
                                            </div>
                                          
                                          
                                            <!-- Submit button -->
                                            <button name="submit" type="submit" class="btn btn-primary btn-block mb-4">Rezervasyon Yap</button>
                                          </form>
