					...
					<div class="offers_sorting_container">
						<ul class="offers_sorting">
							...
							<li>
								...
								<i class="fa fa-chevron-down"></i>
								<ul>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "original-order" }'><span>VARSAYILAN</span></li>
							...
							<div class="row">
								...
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<div class="button book_button"><a href="book.php?id=1&category=cruise">Rezervasyon yap<span></span><span></span><span></span></a></div>
