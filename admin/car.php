...
<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Araba</h1>

					<div class="row">
						<div class="col-12">
							<div class="card">
							<div class="card-header">
								<p><a href="car-add.php">										<button class="btn btn-info">Yeni Araba</button>
</a> </p>
</div>
...
?>
										...
										<td><?php echo $row["id"]; ?></td>
											...
											<td class="d-none d-md-table-cell"><a href="car-update.php?id=<?php echo $row["id"]; ?>">Güncelle</a></td>
										</tr>
