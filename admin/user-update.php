					...
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="card">
								...
								<div class="card-body">
									E-Mail <input type="text" name="newEmail" value="<?php echo $email; ?>" class="form-control" placeholder="Input">
								</div>
								<div class="card-body">
								Şifre	<input type="password" name="newPassword" value="<?php echo $password; ?>" class="form-control" placeholder="Password">
								</div>
								<div class="card-body">
									Kullanıcı Adı <input type="text" name="newUsername" value="<?php echo $username; ?>"  class="form-control" placeholder="Username">
								</div>
								<div class="card-body">
