...
<main class="content">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Kaydırıcı Ekle</h1>
					...
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" name="title1" placeholder="Başlık 1">
								</div>
								<div class="card-body">
                                    <input type="file"  name="image" placeholder="Resim" required>
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="title2" placeholder="Başlık 2">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="button_url" placeholder="Buton Url">
								</div>
                                <div class="card-body">
									<input type="text" class="form-control" name="button_text" placeholder="Buton text">
								</div>
