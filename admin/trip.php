					...
					<div class="row">
						<div class="col-12">
							...
							<div class="card-header">
								<p><a href="trip-add.php">										<button class="btn btn-info">Yeni Gezi</button>
</a> </p>
</div>
...
?>
										...
										<td><?php echo $row["id"]; ?></td>
											...
											<td class="d-none d-md-table-cell"><a href="trip-update.php?id=<?php echo $row["id"]; ?>">Güncelle</a></td>
										</tr>
