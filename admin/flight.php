...
<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Uçuş</h1>

					<div class="row">
						<div class="col-12">
							<div class="card">
							<div class="card-header">
								<p><a href="flight-add.php">										<button class="btn btn-info">Yeni Uçuşlar</button>
</a> </p>
</div>
...
?>
										...
										<td><?php echo $row["id"]; ?></td>
											...
											<td class="d-none d-md-table-cell"><a href="flight-update.php?id=<?php echo $row["id"]; ?>">Güncelle</a></td>
										</tr>
