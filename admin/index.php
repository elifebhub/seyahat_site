        ...
        if($login->rowCount()> 0)
        {
            if(password_verify($password, $fetch['mypassword']))
            {
				if($fetch['admin']==1)
				{
					...
					echo "<script>window.location.href='".APPURL."/admin/user.php';</script>";
...
<head>
	...
	<title>Kayıt Ol | Admin Paneli</title>
							...
							<div class="card-body">
								<div class="m-sm-3">
									<form action="index.php" method="POST">
										...
										<button  name="submit" type="submit" class="btn btn-lg btn-primary"> Giriş Yap</button>
										</div>
									</form>
								</div>
							</div>
