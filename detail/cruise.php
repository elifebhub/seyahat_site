			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="intro_content">
						...
						<div class="button intro_button"><div class="button_bcg"></div><a href="<?php echo APPURL;?>/book.php?id=<?php echo $trip['id']; ?>&category=cruise">Şimdi rezervasyon yap<span></span><span></span><span></span></a></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Çocuklar</div>
					</div>
				</div>
