...
<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Geziler</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="intro_content">
						...
						<div class="button intro_button"><div class="button_bcg"></div><a href="<?php echo APPURL;?>/book.php?id=<?php echo $trip['id']; ?>&category=flight">Şimdi rezervasyon yap<span></span><span></span><span></span></a></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Yetişkinler</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Çocukllar</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Skor</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Kullanıcı Oyu</div>
					</div>
				</div>
