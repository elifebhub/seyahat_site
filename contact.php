			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						<div class="contact_title text-center">İLETİŞİME GEÇİN</div>
						<form method="POST" id="contact_form" class="contact_form text-center">
							<input type="text"  name="name" id="contact_form_name" class="contact_form_name input_field" placeholder="İsim" required="required" data-error="Name is required.">
							...
							<input type="text"  name="subject"   id="contact_form_subject" class="contact_form_subject input_field" placeholder="Konu" required="required" data-error="Subject is required.">
							<textarea id="contact_form_message"  name="description"  class="text_field contact_form_message" name="message" rows="4" placeholder="Mesaj" required="required" data-error="Please, write us a message."></textarea>
							<button name="submit"  type="submit" id="form_submit_button" class="form_submit_button button trans_200">Mesaj Gönder<span></span><span></span><span></span></button>
						</form>
					</div>
